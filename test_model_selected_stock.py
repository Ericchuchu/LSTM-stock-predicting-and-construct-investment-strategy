...
from data_preprocess import TrainDataset, data_preprocess
import os
import sys
...
if __name__ == "__main__" :
    ...
    for stock in selected_stock:
        ...
        testing_model.load_state_dict(torch.load(f'model_state\{args.model}_{stock}_state_predict_sequence.pth'))
        ...
        pred_df.to_csv(f'predicted_result\{args.model} {stock} 2023 predicted prices.csv')
        plot_len = len(true)
